 ...
 * fluidSimScript.ts
 * ─────────────────────────────────────────────────────────────────────────────
 * Navier-Stokes WebGL fluid simulation, adapted from React Bits SplashCursor.
 * Exported as a string and injected by SnapScrollHero via a <script> tag.
 *
 * The simulation targets an element with id="tts-fluid-canvas".
 * ─────────────────────────────────────────────────────────────────────────────
 */

export const FLUID_SIM_SCRIPT = `(function () {
